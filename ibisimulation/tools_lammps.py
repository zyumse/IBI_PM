...
def write_lammps(file_name, lmp_tmp):
    """
...
class lammps:
    def __init__(self, natoms=0, natom_types=0, x=[0, 0], y=[0, 0], z=[0, 0], mass=[], atom_info=[], nbonds=0, nangles=0, ndihedrals=0, nimpropers=0, nbond_types=0, nangle_types=0, ndihedral_types=0, nimproper_types=0, pair_coeff=None, bond_coeff=None, angle_coeff=None, dihedral_coeff=None, improper_coeff=None, velocity_info=None, bond_info=[], angle_info=[], dihedral_info=[], improper_info=[]):
        self.natoms = natoms
        self.nbonds = nbonds
